...
<div class="row">
    ...
    <div class="col-sm-8" style="background-color:mediumspringgreen;"><br>
        <h3>NEWS</h3>
        <form action="${pageContext.request.contextPath}/admin/news/add" method="get">
            <div class="form-group"><br>
                <input type="hidden">
                <button type="submit" class="btn">Add</button>
            </div>
        </form>
        <form action="${pageContext.request.contextPath}/admin/news/update" method="get">
            <div class="form-group"><br>
                <input type="hidden">
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="news" items="${newsDTOList}">
                <tr>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/admin/news/one" method="post">
                            <div class="form-group"><br>
                                <input type="hidden" name="newsname" value="${news.newsname}">
