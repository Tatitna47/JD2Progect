...
<div class="row">
    ...
    <div class="col-sm-6" style="background-color:mediumspringgreen;"><br>
        <h3>ITEMS</h3>
        <form action="${pageContext.request.contextPath}/superadmin/item/add" method="get">
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="item" items="${itemDTOList}">
                <tr>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/superadmin/item/delete" method="post">
                            <div class="form-group"><br>
                                <input type="hidden" name="id" value="${item.id}">
                                <button type="submit" class="btn">Delete</button>
                            </div>
                        </form>
                        <form action="${pageContext.request.contextPath}/superadmin/item/copy" method="post">
                            <div class="form-group"><br>
                                <input type="hidden" name="id" value="${item.id}">
